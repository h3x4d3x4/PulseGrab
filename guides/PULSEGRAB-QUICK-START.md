...
2. Enter your **GitHub Personal Access Token** (for private repo access)
3. Enable **Auto-Check for Updates** to receive notifications when new versions are available
